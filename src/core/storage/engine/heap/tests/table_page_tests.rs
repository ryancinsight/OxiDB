...
fn test_insert_and_get_row_with_vector() {
    ...
    let serialized_row = crate::core::common::bincode_compat::serialize_to_vec(&original_row)
    ...
    let retrieved_row: Row =
        crate::core::common::bincode_compat::deserialize(&mut retrieved_serialized_row.as_slice())
