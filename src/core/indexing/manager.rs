...
impl IndexManager {
    ...
    // Update operation would involve a delete of old values and insert of new values.
    // pub fn on_update_data(&self, old_values: &HashMap<String, Value>, new_values: &HashMap<String, Value>, primary_key: &PrimaryKey) -> Result<(), DbError> {
    //     self.on_delete_data(old_values, primary_key)?;
    //     self.on_insert_data(new_values, primary_key)?;
    //     Ok(())
    // }
