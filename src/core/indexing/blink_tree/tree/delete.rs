...
impl BlinkTreeIndex {
    ...
    fn handle_underflowing_leaf(&mut self, _leaf_page_id: super::PageId) -> Result<(), BlinkTreeError> {
    ...
    fn handle_underflowing_internal(&mut self, _internal_page_id: super::PageId) -> Result<(), BlinkTreeError> {
