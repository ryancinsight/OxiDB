...
pub use storage::{VectorStore, VectorEntry};
pub use transaction::{VectorTransactionManager, TransactionId};
    ...
    fn similarity(&self, other: &VectorData, metric: SimilarityMetric) -> Result<f32, OxidbError> {
        ...
        match metric {
            ...
            SimilarityMetric::Euclidean => {
                ...
                let distance = self.euclidean_distance(other)
                    .ok_or(OxidbError::VectorDimensionMismatch {
                        dim1: self.dimension as usize,
                        dim2: other.dimension as usize,
                    })?;
...
impl VectorFactory {
    ...
    pub fn create_vector(dimension: u32, data: Vec<f32>) -> Result<VectorData, OxidbError> {
        ...
        let vector = VectorData::new(dimension, data)
            .ok_or(OxidbError::VectorDimensionMismatch {
    ...
    pub fn create_normalized_vector(dimension: u32, data: Vec<f32>) -> Result<VectorData, OxidbError> {
