...
impl GraphRAGFactory {
    ...
    pub fn create_default(graph_store: Arc<dyn GraphStore>) -> GraphRAGEngineImpl {
        ...
        GraphRAGEngineImpl::new(graph_store, embedder, config)
    }
    
    /// Create a high-precision GraphRAG engine
    pub fn create_high_precision(graph_store: Arc<dyn GraphStore>) -> GraphRAGEngineImpl {
        let config = GraphRAGConfig {
    ...
    pub fn create_fast(graph_store: Arc<dyn GraphStore>) -> GraphRAGEngineImpl {
        let config = GraphRAGConfig {
