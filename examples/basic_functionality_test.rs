...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    conn.execute(
        "INSERT INTO products (id, name, price, category_id) VALUES (2, 'Mouse', 29.99, 2)",
    )?;
    conn.execute(
        "INSERT INTO products (id, name, price, category_id) VALUES (3, 'Desk', 299.99, 3)",
    )?;
    conn.execute(
        "INSERT INTO products (id, name, price, category_id) VALUES (4, 'Keyboard', 79.99, 2)",
    )?;
